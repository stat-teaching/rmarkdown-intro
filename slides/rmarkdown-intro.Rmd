...
Abbiamo un grafico, creato in R e vogliamo inserirlo nel documento:
...
Nel **literate programming** invece l'idea è che un certo elemento (ad esempio un grafico) viene creato con un pezzo di codice e quindi posso integrare il codice (e non l'immagine) con il testo. Essendo poi compilato, il testo sarà intepretato come testo ed il codice verrà sostuito dall'immagine.
...
# You are ready to create amazing documents `r emo::ji("smile")`
